                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Liste administrateur   </li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title">Liste administrateur</strong>
                            </div>
                            <?php

                            $res2 = administrateur::lister();
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    foreach ($res2 as $enr2) {
                                        ?>
                                        <tr>
                                            <th><?php echo $enr2['id_admin'] ?></th>
                                            <td><?php echo $enr2['login'] ?></td>
                                            <td>
                                                <a class="btn btn-warning btn-sm" href=modifier_administrateur.php?id_admin=<?php echo  $enr2['id_admin'] ?> ><i class="fa fa-map-marker"></i>&nbsp; Modifier</a>
                                                <a class="btn btn-danger btn-sm" href=supprimer_administrateur.php?id_admin=<?php echo  $enr2['id_admin'] ?> ><i class="fa fa-rss"></i>&nbsp; Supprimer</a></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
