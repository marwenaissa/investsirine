                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title">Liste des contacts</strong>
                            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    ?>
                                        <tr class="<?php echo $rowClass; ?>">
                                            ...
                                            <td>
                                                <a class="btn btn-danger btn-sm" href="supprimer_contact.php?id=<?php echo $enr1['id']; ?>">
                                                    <i class="fa fa-trash"></i> Supprimer
                                                </a>
                                                <a class="btn btn-<?php echo $isLue ? 'secondary' : 'info'; ?> btn-sm" href="consulter_contact.php?id=<?php echo $enr1['id']; ?>">
                            ...
                            ?>
                             <div class="card-body">
                                <h4 class="text-center">Pas de contact</h4>
                            </div>
