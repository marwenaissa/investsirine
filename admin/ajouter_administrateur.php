                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Ajout administrateur</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title" >Ajout administrateur</strong>
                            </div>
                           
                            <form name = "form1" method = "post" action="ajouter_administrateur.php" >
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th >Mot de passe</th>
                                            <td><input class="form-control"  type = "text" name = "mot_de_passe" value = ""></td>
                                        </tr>
                                        <tr>
                            ...
                            if (isset($_POST["ajouter"])) {
                                ...
                                $admin = new administrateur( $_POST["login"], $_POST["mot_de_passe"]);
                                $res = $admin->ajouter();
                                
                                // Check if the insertion was successful
                                if ($res === true) {
                                    echo '<script>alert("L\'administrateur a été ajouté avec succès");window.history.go(-1);</script>';
                                } else {
                                    echo($res);
