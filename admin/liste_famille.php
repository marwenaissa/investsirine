                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Liste famille</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title">Liste famille</strong>
                            </div>
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            <th scope="row"><?php echo $enr1['idfam'] ?></th>
                                                <td><?php echo $enr1['designationf'] ?></td>
                                            <td>
                                            <a class="btn btn-warning btn-sm" href=modifier_famille.php?code_famille="<?php echo $enr1['idfam'] ?>"><i class="fa fa-map-marker"></i>&nbsp;  Modifier</a>
                                            <a class="btn btn-danger btn-sm" href=supprimer_famille.php?code_famille="<?php echo $enr1['idfam'] ?>"><i class="fa fa-rss"></i>&nbsp;   Supprimer</a>
                            ...
                            ?>
                             <div class="card-body">
                                <h4 class="text-center">Pas de famille</h4>
                            </div>
