...
if (isset($_POST['Modifier']))
{
    ...
    $pl= new administrateur($_POST["login"],$_POST["mot_de_passe"]);
    $pl->id_admin=$_POST["id_admin"];
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form name = "form1" method = "post" action="modifier_administrateur.php" >

                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <th scope="col">ID Administrateur</th>
                                            <td><input class="form-control"  type = "text" name = "id_admin" value="<?php echo $admin->id_admin; ?>" style="color: #808080;" readonly></td>
                                        </tr>
                                        <tr>
                                            <th scope="col">Login</th>
                                            <td><input class="form-control"  type = "text" name = "login" value = <?php echo $admin->login; ?> ></td>
                                        </tr>
                                        <tr>
                                            <th scope="col">Mot de passe</th>
                                            <td><input class="form-control"  type = "text" name = "mot_de_passe" value = <?php echo $admin->mot_de_passe; ?> ></td>
                                        </tr>
