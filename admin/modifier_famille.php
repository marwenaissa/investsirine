...
if (isset($_POST['Modifier']))
{
    ...
    $pl= new famille($_POST["idfam"],$_POST["designationf"]);
...
<body>
    <?php
        include("classes.php");
        $famille = famille::lecture($_GET["code_famille"]);
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Gestion famille</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title" >Modifier famille</strong>
                            </div>
                           
                            <form name = "form1" method = "post" action="modifier_famille.php" >
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input class="form-control" style="color: #808080;" type = "text" name = "idfam" value="<?php echo $famille->idfam; ?>" readonly></td>
                                        </tr>
                                        <tr>
                                            <td>Designation</td>
                                            <td>
                                                <input class="form-control" name="designationf" type="text" value="<?php echo $famille->designationf; ?>">
                                            </td>
                                        </tr>
                                        <tr>
