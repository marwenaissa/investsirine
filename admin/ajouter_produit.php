                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title" style="">Ajout produit</strong>
                            </div>
                           

                            <form name = "form1" method = "post" action="ajouter_produit.php" >
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input class="form-control"  type = "text" name = "designation_produit" value = ""></td>
                                        </tr>
                                        <tr>
                                            <th scope="col">Quantité</th>
                                            <td><input class="form-control"  type = "text" name = "quantite_stock" value = ""></td>
                                        </tr>
                                        <tr>
                                            <th scope="col">Prix unitaire</th>
                                            <td><input class="form-control"  type = "text" name = "prix_unitaire" value = ""></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align = "center">
                                                <button name ="ajouter" type = "submit" style="margin-right:20px" class="btn btn-primary btn-sm"><i class="fa fa-star"></i>&nbsp; Ajouter</button>
                                                <button name ="annuler" type = "reset" style="margin-right:20px" class="btn btn-secondary btn-sm"><i class="fa fa-lightbulb-o"></i>&nbsp; Annuler</button>
                                            </td>                                          
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            {
                                if(empty($_POST["designation_produit"]))
                                {
                                    echo'<script>alert("Un ou plusieurs champs ne sont pas remplis");window.history.go(-1);</script>';
                                }
                                else
                                {
                                    $fl=new produit($_POST["designation_produit"],$_POST["quantite_stock"],$_POST["prix_unitaire"],$_POST["idfam"]);
                                    $res=$fl->ajouter();
                                    if($res==true)
                                    {
                                        echo'<script>alert("le produit a ete ajoutee avec
                                        succes");window.history.go(-1);</script>';
                                    }
                                    else
                                    {
                                        echo($res);
