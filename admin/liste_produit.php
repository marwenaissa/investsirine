                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Liste produit</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title" style="text-align: center !important;">Liste produit</strong>
                            </div>
                            <?php
                            $res2 = produit::lister();
                            $familles = famille::lister();
                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                    foreach ($res2 as $enr2) {

                                    $nomfamille = '';
                                    foreach ($familles as $famille) {
                                        if ($famille['idfam'] == $enr2['idfam']) {
                                            $nomfamille = $famille['designationf']; 
                                        }
                                    }
                                    ?>

                                        <tr>
                                            <th><?php echo $enr2['idprod'] ?></th>
                                            <td><?php echo $enr2['designation_prod'] ?></td>
                                            <td><?php echo $enr2['quantite_stock'] ?></td>
                                            <td><?php echo $enr2['prix_unitaire'] ?></td>
                                            <td><?php echo $nomfamille ?></td>
                                            <td>
                                                <a class="btn btn-warning btn-sm" href=modifier_produit.php?code_produit="<?php echo $enr2['idprod'] ?>"><i class="fa fa-map-marker"></i>&nbsp; Modifier </a>
                                                <a class="btn btn-danger btn-sm" href=supprimer_produit.php?code_produit="<?php echo $enr2['idprod'] ?>    "><i class="fa fa-rss"></i>&nbsp;  Supprimer</a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
                            ...
                            <div class="card-body">
                                <h4 class="text-center">Pas de produit</h4>
                            </div>
