                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Ajout famille</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-header" style="text-align: center !important;background-color:#007bff">
                                <strong class="card-title" >Ajout famille</strong>
                            </div>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr> 
                                            ...
                                            <td><input class="form-control" type = "text" name = "id_famille" value = "" ></td>
                                        </tr>

                                        <tr>
                                            <th scope="col">Designation</th>
                                            <td><input class="form-control"  type = "text" name = "designationf" value = ""></td>
                                        </tr>
                                        <tr>
                            ...
                            {
                                if(empty( $_POST["id_famille"]) && empty($_POST["designationf"]))
                                {
                                    echo'<script>alert("Un ou plusieurs champs ne sont pas remplis");window.history.go(-1);</script>';
                                }
                                else
                                {
                                    $fl=new famille($_POST["id_famille"],$_POST["designationf"]);
                                    $res=$fl->ajouter();
                                    if($res==true)
                                    {
                                        echo'<script>alert("la famille a ete ajoutee avec
