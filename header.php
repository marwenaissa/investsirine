...
<div class="container mx-auto px-4 py-4 flex items-center justify-between flex-wrap <?= $lang === 'ar' ? 'flex-row-reverse' : '' ?>">
    ...
    <!-- Menu principal -->
<ul id="nav-menu" class="hidden md:flex flex-col md:flex-row <?= $lang === 'ar' ? 'md:flex-row-reverse' : '' ?> md:items-center w-full md:w-auto gap-6 mt-4 md:mt-0 text-lg font-semibold text-center">
      <li>
